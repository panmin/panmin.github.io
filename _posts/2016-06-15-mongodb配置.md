...
```
D:\Program Files\MongoDB\Server\3.4\bin> **mongod -dbpath="D:\Program Files\MongoDB\Server\3.4\data\db" -logpath="D:\Program Files\MongoDB\Server\3.4\data/log/mongodb.log" -logappend**
```
